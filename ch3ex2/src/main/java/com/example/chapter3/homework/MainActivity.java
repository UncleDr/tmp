...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        int min_WH = width>height?height:width;
        //获取物件宽度的最小值。
        ViewGroup.LayoutParams layoutParams = target.getLayoutParams();
        //使物件从原来的大小放大到 屏幕的宽度/物件原本的宽度，这样放大后就能撑满整个屏幕
        PropertyValuesHolder pvhX = PropertyValuesHolder.ofFloat(View.SCALE_X, 1,min_WH/(float)layoutParams.width);
        PropertyValuesHolder pvhY = PropertyValuesHolder.ofFloat(View.SCALE_Y, 1,min_WH/(float)layoutParams.width);
        ObjectAnimator animator2 = ObjectAnimator.ofPropertyValuesHolder(target, pvhX,
                pvhY);
        ...
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(target, View.ALPHA, 1,0.5f);
